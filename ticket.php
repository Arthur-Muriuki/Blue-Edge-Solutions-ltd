...
if (empty($ref)) {
    die("<div style='padding:50px; text-align:center;'><h2>Invalid Ticket Reference</h2><a href='shop.php'>Return to Shop</a></div>");
}
...
if (!$order) {
    die("<div style='padding:50px; text-align:center;'><h2>Order Ticket Not Found</h2><p>Reference: " . htmlspecialchars($ref) . "</p><a href='shop.php'>Return to Shop</a></div>");
}
...
$page_title = "Ticket " . htmlspecialchars($order['reference_code']) . " | Blue Edge Solutions";
